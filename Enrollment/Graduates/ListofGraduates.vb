...
Public Class ListofGraduates
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ListofGraduates.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListofGraduates
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListofGraduates = New ListofGraduates
        rpt.Site = Me.Site
        Return rpt
    End Function
