...
Public Class gradCertification
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.gradCertification.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedgradCertification
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As gradCertification = New gradCertification
        rpt.Site = Me.Site
        Return rpt
    End Function
