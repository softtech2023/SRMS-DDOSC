...
Public Class GradingSheet_Old
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.GradingSheet_Old.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGradingSheet_Old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GradingSheet_Old = New GradingSheet_Old
        rpt.Site = Me.Site
        Return rpt
    End Function
