...
Public Class frmSearchProfileForVerification
    ...
    Private Sub dgstudentsearch_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dg1.DoubleClick
        Try
            ...
            frmStudentVerification.lblStudentNumber.Text = dg1.Item(0, i).Value
            frmStudentVerification.getDetails()
            frmStudentVerification.getYearLevel()
            frmStudentVerification.getUnitsEarned()
            frmStudentVerification.btnPreview.Enabled = True

            'CAV
            frmCAV.lblStudentNumber.Text = dg1.Item(0, i).Value
            frmCAV.getDetails()
            frmCAV.getYearLevel()
            frmCAV.getUnitsEarned()
            frmCAV.btnPreview.Enabled = True
