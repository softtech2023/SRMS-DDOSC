...
Public Class Permanent_Record
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.Permanent-Record.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPermanent_Record
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Permanent_Record = New Permanent_Record
        rpt.Site = Me.Site
        Return rpt
    End Function
