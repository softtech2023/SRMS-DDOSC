...
Public Class COR1
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_yearLevelStat() As CrystalDecisions.[Shared].IParameterField
        Get
