...
Public Class ListbyProvince
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ListbyProvince.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListbyProvince
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListbyProvince = New ListbyProvince
        rpt.Site = Me.Site
        Return rpt
    End Function
