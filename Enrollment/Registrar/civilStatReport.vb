...
Public Class civilStatReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.civilStatReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcivilStatReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As civilStatReport = New civilStatReport
        rpt.Site = Me.Site
        Return rpt
    End Function
