...
Public Class EnrolmentStatReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EnrolmentStatReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.EnrolmentStatReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_enrollStat() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEnrolmentStatReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EnrolmentStatReport = New EnrolmentStatReport
        rpt.Site = Me.Site
        Return rpt
    End Function
