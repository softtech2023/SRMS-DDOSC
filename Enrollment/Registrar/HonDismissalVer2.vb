...
Public Class HonDismissalVer2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.HonDismissalVer2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHonDismissalVer2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HonDismissalVer2 = New HonDismissalVer2
        rpt.Site = Me.Site
        Return rpt
    End Function
