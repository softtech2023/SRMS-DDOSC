...
Public Class ByYearLevelStat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ByYearLevelStat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedByYearLevelStat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ByYearLevelStat = New ByYearLevelStat
        rpt.Site = Me.Site
        Return rpt
    End Function
