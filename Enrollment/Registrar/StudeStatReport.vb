...
Public Class StudeStatReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.StudeStatReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStudeStatReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StudeStatReport = New StudeStatReport
        rpt.Site = Me.Site
        Return rpt
    End Function
