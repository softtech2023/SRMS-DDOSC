...
Public Class ListByEthnicity
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ListByEthnicity.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListByEthnicity
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListByEthnicity = New ListByEthnicity
        rpt.Site = Me.Site
        Return rpt
    End Function
