...
Public Class ReportofGrades
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ReportofGrades.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportofGrades
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportofGrades = New ReportofGrades
        rpt.Site = Me.Site
        Return rpt
    End Function
