...
Public Class ListByReligion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ListByReligion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListByReligion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListByReligion = New ListByReligion
        rpt.Site = Me.Site
        Return rpt
    End Function
