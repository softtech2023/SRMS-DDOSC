...
Public Class Form137_request
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.Form137-request.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedForm137_request
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Form137_request = New Form137_request
        rpt.Site = Me.Site
        Return rpt
    End Function
