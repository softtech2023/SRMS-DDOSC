...
Public Class CSEmployeeReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.CSEmployeeReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCSEmployeeReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CSEmployeeReport = New CSEmployeeReport
        rpt.Site = Me.Site
        Return rpt
    End Function
