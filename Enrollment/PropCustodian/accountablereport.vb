...
Public Class accountablereport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.accountablereport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedaccountablereport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As accountablereport = New accountablereport
        rpt.Site = Me.Site
        Return rpt
    End Function
