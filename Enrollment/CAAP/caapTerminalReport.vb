...
Public Class caapTerminalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.caapTerminalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcaapTerminalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As caapTerminalReport = New caapTerminalReport
        rpt.Site = Me.Site
        Return rpt
    End Function
