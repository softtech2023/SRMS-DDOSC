...
Public Class EthnicityChart
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.EthnicityChart.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEthnicityChart
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EthnicityChart = New EthnicityChart
        rpt.Site = Me.Site
        Return rpt
    End Function
