...
Public Class statProgramChart
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.statProgramChart.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedstatProgramChart
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As statProgramChart = New statProgramChart
        rpt.Site = Me.Site
        Return rpt
    End Function
