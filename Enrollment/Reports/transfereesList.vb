...
Public Class transfereesList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.transfereesList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedtransfereesList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As transfereesList = New transfereesList
        rpt.Site = Me.Site
        Return rpt
    End Function
