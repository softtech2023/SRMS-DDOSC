...
Public Class PromissoryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.PromissoryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPromissoryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PromissoryReport = New PromissoryReport
        rpt.Site = Me.Site
        Return rpt
    End Function
