...
Public Class StudeAccounts_All
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.StudeAccounts_All.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStudeAccounts_All
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StudeAccounts_All = New StudeAccounts_All
        rpt.Site = Me.Site
        Return rpt
    End Function
