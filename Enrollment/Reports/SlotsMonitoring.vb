...
Public Class SlotsMonitoring
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.SlotsMonitoring.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSlotsMonitoring
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SlotsMonitoring = New SlotsMonitoring
        rpt.Site = Me.Site
        Return rpt
    End Function
