...
Public Class frmProspectusDashboard
    Dim str As String
    Private Sub btnPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreview.Click
        Try
            str = "SELECT subjectid, SubjectCode, description, lecunit, labunit, prereq, concat(YearLevel,' ',Semester) as Semester, Course, Major FROM subjects where Course='" & cboCourse.Text & "' and Major='" & cboMajor.Text & "' group by Semester order by Semester"
            conn.Open()
            Dim mysda As New MySqlDataAdapter(Str, conn)
            Dim mysds As New DataSet
            mysda.Fill(mysds, "subjects")
            Dim obj As New Prospectus
    ...
    Private Sub frmProspectusDashboard_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        getCourse()
        getCourseMajor()
    End Sub
