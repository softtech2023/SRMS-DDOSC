...
Public Class SemesterStudeList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.SemesterStudeList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSemesterStudeList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SemesterStudeList = New SemesterStudeList
        rpt.Site = Me.Site
        Return rpt
    End Function
