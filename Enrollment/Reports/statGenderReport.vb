...
Public Class statGenderReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.statGenderReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedstatGenderReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As statGenderReport = New statGenderReport
        rpt.Site = Me.Site
        Return rpt
    End Function
