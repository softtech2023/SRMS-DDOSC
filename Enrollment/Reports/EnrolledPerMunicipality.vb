...
Public Class EnrolledPerMunicipality
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EnrolledPerMunicipality.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.EnrolledPerMunicipality.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Course() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEnrolledPerMunicipality
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EnrolledPerMunicipality = New EnrolledPerMunicipality
        rpt.Site = Me.Site
        Return rpt
    End Function
