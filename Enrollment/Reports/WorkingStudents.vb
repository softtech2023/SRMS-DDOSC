...
Public Class WorkingStudents
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.WorkingStudents.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWorkingStudents
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WorkingStudents = New WorkingStudents
        rpt.Site = Me.Site
        Return rpt
    End Function
