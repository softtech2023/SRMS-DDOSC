...
Public Class statReligionReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.statReligionReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedstatReligionReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As statReligionReport = New statReligionReport
        rpt.Site = Me.Site
        Return rpt
    End Function
