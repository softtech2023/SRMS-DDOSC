...
Public Class ReligionCounts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ReligionCounts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReligionCounts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReligionCounts = New ReligionCounts
        rpt.Site = Me.Site
        Return rpt
    End Function
