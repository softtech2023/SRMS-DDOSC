...
Public Class crossEnrolleesList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.crossEnrolleesList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrossEnrolleesList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crossEnrolleesList = New crossEnrolleesList
        rpt.Site = Me.Site
        Return rpt
    End Function
