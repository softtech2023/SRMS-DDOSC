...
Public Class statCourseReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.statCourseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedstatCourseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As statCourseReport = New statCourseReport
        rpt.Site = Me.Site
        Return rpt
    End Function
