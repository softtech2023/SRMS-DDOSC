...
Public Class DailyCollections
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.DailyCollections.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyCollections
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyCollections = New DailyCollections
        rpt.Site = Me.Site
        Return rpt
    End Function
