...
Public Class ScholarsListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ScholarsListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedScholarsListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ScholarsListing = New ScholarsListing
        rpt.Site = Me.Site
        Return rpt
    End Function
