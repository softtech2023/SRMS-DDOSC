...
Public Class OfficialReceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.OfficialReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cashier() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedOfficialReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OfficialReceipt = New OfficialReceipt
        rpt.Site = Me.Site
        Return rpt
    End Function
