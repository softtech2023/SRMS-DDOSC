...
Public Class ScholarsByCourse
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ScholarsByCourse.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedScholarsByCourse
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ScholarsByCourse = New ScholarsByCourse
        rpt.Site = Me.Site
        Return rpt
    End Function
