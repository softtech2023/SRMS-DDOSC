...
Public Class PaymentHistory1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.PaymentHistory1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaymentHistory1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaymentHistory1 = New PaymentHistory1
        rpt.Site = Me.Site
        Return rpt
    End Function
