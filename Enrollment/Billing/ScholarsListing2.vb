...
Public Class ScholarsListing2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ScholarsListing2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedScholarsListing2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ScholarsListing2 = New ScholarsListing2
        rpt.Site = Me.Site
        Return rpt
    End Function
