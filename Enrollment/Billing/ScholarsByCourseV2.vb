...
Public Class ScholarsByCourseV2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ScholarsByCourseV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedScholarsByCourseV2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ScholarsByCourseV2 = New ScholarsByCourseV2
        rpt.Site = Me.Site
        Return rpt
    End Function
