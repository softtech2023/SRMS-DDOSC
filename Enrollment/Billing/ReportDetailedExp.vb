...
Public Class ReportDetailedExp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ReportDetailedExp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportDetailedExp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportDetailedExp = New ReportDetailedExp
        rpt.Site = Me.Site
        Return rpt
    End Function
