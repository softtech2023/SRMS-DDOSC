    ...
    Private Sub dgsubjects_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dg1.DoubleClick
        Try
            ...
            For x As Integer = 0 To frmCOR.lvCOR.Items.Count - 1
                If dg1.Item(1, i).Value = frmCOR.lvCOR.Items(x).SubItems(0).Text And dg1.Item(2, i).Value = frmCOR.lvCOR.Items(x).SubItems(1).Text Then
                    MsgBox("Adding the same subject to the same student is not allowed!", MsgBoxStyle.Exclamation)
                    Exit Sub
                End If
            Next
            frmCOR.lblSlot.Text = dg1.Item(9, i).Value
            frmCOR.getFinalSlot()

            AddSemSubjects(frmCOR.lvCOR, dg1.Item(1, i).Value, dg1.Item(2, i).Value, dg1.Item(7, i).Value, dg1.Item(6, i).Value, dg1.Item(8, i).Value, dg1.Item(5, i).Value, dg1.Item(3, i).Value, dg1.Item(4, i).Value, dg1.Item(13, i).Value, frmCOR.lblFinalSlot.Text, dg1.Item(28, i).Value, frmCOR.lblFinalSlot.Text)
