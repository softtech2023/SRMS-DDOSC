...
Public Class frmSemStudent
    ...
    Private Sub tsSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsSave.Click
        Try
            ...
            'update grades
            str = "update grades set Course='" & cboCourse.Text & "',Major='" & cboMajor.Text & "' where StudentNumber='" & mskStudentNumber.Text & "' and Semester='" & frmParent.lblSem.Text & "' and SY='" & frmParent.lblSY.Text & "'"
            conn.Open()
            Dim mysC5 As New MySqlCommand(str, conn)
            mysC5.ExecuteNonQuery()
            conn.Close()

            'update online enrollment
            str = "update online_enrollment set enrolStatus='Enrolled' where StudentNumber='" & mskStudentNumber.Text & "' and Semester='" & frmParent.lblSem.Text & "' and SY='" & frmParent.lblSY.Text & "'"
            conn.Open()
    ...
    Private Sub tsUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsUpdate.Click
        Try
            ...
            'update registration
            str = "update registration set courseCode='" & txtCourseCode.Text & "',Course='" & cboCourse.Text & "',YearLevel='" & cboYear.Text & "',Major='" & cboMajor.Text & "',Section='" & cboSection.Text & "' where StudentNumber='" & mskStudentNumber.Text & "' and Sem='" & frmParent.lblSem.Text & "' and SY='" & frmParent.lblSY.Text & "'"
            conn.Open()
            ...
            'update grades
            str = "update grades set Course='" & txtCourseCode.Text & "',Major='" & cboMajor.Text & "' where StudentNumber='" & mskStudentNumber.Text & "' and Semester='" & frmParent.lblSem.Text & "' and SY='" & frmParent.lblSY.Text & "'"
            conn.Open()
            Dim mysC5 As New MySqlCommand(str, conn)
            mysC5.ExecuteNonQuery()
            conn.Close()
    ...
    Private Sub tsDrop_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsDrop.Click
        Try
            If tsDrop.Text = "Drop" Then
                ...
                Reload()
            Else
                str = "update semesterstude set Status='Enrolled' where StudentNumber='" & mskStudentNumber.Text & "' and Semester='" & frmParent.lblSem.Text & "' and SY='" & frmParent.lblSY.Text & "'"
                conn.Open()
                Dim mysC As New MySqlCommand(str, conn)
                mysC.ExecuteNonQuery()
                conn.Close()
                ...
                'Audit Trail
                str = "insert into atrail values('0','Change the status of a student from DROPPED to ENROLLED','" & frmParent.dtpDate.Text & "','" & frmParent.stTime.Text & "','" & frmParent.lblUser.Text & "','" & mskStudentNumber.Text & "')"
                conn.Open()
                Dim mysc8 As New MySqlCommand(str, conn)
                mysc8.ExecuteNonQuery()
                conn.Close()

                MsgBox("The selected student has been enrolled successfully.", MsgBoxStyle.Information)
                Reload()
            End If
    ...
    Private Sub cboCourse_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCourse.SelectedValueChanged
        getCourseMajor()
        getCourseCode()
    End Sub

    Public Sub transferee()
        If cboStudeStatus.Text = "Transferee" Or cboStudeStatus.Text = "New" Then
            btnSelectSchool.Enabled = True
        Else
            btnSelectSchool.Enabled = False
            txtSchool.Clear()
            txtSchoolAddress.Clear()
    ...
    Private Sub cboTransferee_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        transferee()
    End Sub

    Private Sub btnSelectSchool_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelectSchool.Click
        frmSelectSchool0.Show()
    End Sub

    Private Sub cboStudeStatus_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboStudeStatus.SelectedIndexChanged
        transferee()
    End Sub
End Class