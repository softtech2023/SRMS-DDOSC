...
Public Class frmSelectSchool0
    ...
    Private Sub dg1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dg1.DoubleClick
        ...
        frmStudeProfile.txtElementary.Text = dg1.Item(1, i).Value
        frmStudeProfile.txtElemAddress.Text = dg1.Item(2, i).Value

        frmSemStudent.txtSchool.Text = dg1.Item(1, i).Value
        frmSemStudent.txtSchoolAddress.Text = dg1.Item(2, i).Value
